...
const STRINGS = {
    es: {
        ...
        tooltipYes:       'Sí',
        tooltipNo:        'No',
        cookieMsg:        'Esta app usa <strong>localStorage</strong> para guardar tu equipo localmente, una cookie de sesión para autenticarte y almacena tu perfil en nuestro servidor. Sin publicidad ni rastreo de terceros.',
        cookieOk:         'Entendido',
    ...
    en: {
        ...
        tooltipYes:       'Yes',
        tooltipNo:        'No',
        cookieMsg:        'This app uses <strong>localStorage</strong> to save your team locally, a session cookie for authentication, and stores your profile on our server. No ads or third-party tracking.',
        cookieOk:         'Got it',
