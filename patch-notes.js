const PATCH_NOTES = [
    {
        id: 'pokemon_search',
        date: '23/06/2026',
        title: { es: 'Búsqueda de Pokémon', en: 'Pokemon Search' },
        body:  { es: 'Ahora en la tabla de tipos puedes buscar a un pokémon y ver directamente sus debilidades.', en: 'Now you can search for a pokemon in the type table and see its weaknesses directly.' },
    },
    {
        id: 'sprites_themes',
        date: '24/06/2026',
